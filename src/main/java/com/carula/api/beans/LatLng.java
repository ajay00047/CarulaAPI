...
public class LatLng {
    ...
    public LatLng(double var1, double var3,int distance) {
        if(-180.0D <= var3 && var3 < 180.0D) {
            this.longitude = var3;
        } else {
            this.longitude = ((var3 - 180.0D) % 360.0D + 360.0D) % 360.0D - 180.0D;
    ...
    public String toString() {
        ...
        return (new StringBuilder(100)).append("lat/lng: ( ").append(var1).append(",").append(var3).append(" dist: "+this.distance+" )").toString();
    }
}
