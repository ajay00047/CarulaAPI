...
public class Utils {
	...
	public static Date convertSQLDateString2JavaDate(String sqlDateString) {
		Date returnDate = new Date();
		SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		try {
			returnDate = sdf1.parse(sqlDateString);
		} catch (Exception e) {
		}
	...
	public static String addMinutes2SQLDateString(String sqlDateString, int minutes) {
		String returnDate = "";
		Date date = new Date();
		Calendar calendar = Calendar.getInstance();
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		try {
			date = sdf.parse(sqlDateString);
